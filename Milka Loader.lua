...
Tabs.Info:CreateParagraph("Development Team", {
	...
	Content = "This script was made by the Milka Development Team."
})

Tabs.Info:CreateButton({
	Title = "Copy Discord Link",
	Description = "Click to copy the Milka Discord server link to your clipboard.",
	Callback = function()
		local discordLink = "https://discord.gg/RJC3sFKVkn"
		pcall(function()
